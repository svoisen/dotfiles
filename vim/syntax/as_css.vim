...
syn region cssFontDescriptorBlock contained transparent matchgroup=cssBraces start="{" end="}" contains=cssComment,cssError,cssUnicodeEscape,cssFontProp,cssFontAttr,cssCommonAttr,cssStringQ,cssStringQQ,cssFontDescriptorProp,cssValue.*,cssFontDescriptorFunction,cssUnicodeRange,cssFontDescriptorAttr,cssFlex
...
syn match cssFontProp contained "\<font\(\(Family\|Style\|Variant\|Weight\|Size\=\)\>\)\="
...
syn match cssTextProp "\<\(\(word\|letter\)Spacing\|text\(Decoration\|Transform\|Align\|Index\|Shadow\)\=\|verticalAlign\|unicodeBidi\|lineHeight\)\>"
syn match cssTextAttr contained "\<lineThrough\>"
syn match cssTextAttr contained "\<textIndent\>"
...
syn match cssGeneratedContentProp contained "\<listStyle\(\(Type\|Position\|Image\)\)\=\>"
...
syn match cssFlex contained "\<\(advancedAntiAliasing\|fontAntiAliasing\|fontGridFitType\|fontSharpness\)\=\>"
syn match cssFlex contained "\<\(kerning\|leading\)\=\>"
syn match cssFlex contained "\<\(horizontal\|vertical\)\(Align\|Center\|Gap\|ScrollBarStyleName\)\=\>"
syn match cssFlex contained "\<\(stroke\)\(Width\|Color\)\=\>"
syn match cssFlex contained "\<\(error\|disabled\|theme\)\(Color\)\=\>"
syn match cssFlex contained "\<\(background\)\(Alpha\|DisabledColor\|Size\)\=\>"
syn match cssFlex contained "\<\(border\)\(Sides\|Thickness\|Skin\)\=\>"
syn match cssFlex contained "\<\(barColor\|cornerRadius\|disabledOverlayAlpha\)\=\>"
syn match cssFlex contained "\<\(shadow\)\(Direction\|Distance\)\=\>"
syn match cssFlex contained "\<\(dropShadow\)\(Enabled\|Color\)\=\>"
...
syn region cssDefinition transparent matchgroup=cssBraces start='{' end='}' contains=css.*Attr,css.*Prop,cssComment,cssValue.*,cssColor,cssURL,cssImportant,cssError,cssStringQ,cssStringQQ,cssFunction,cssUnicodeEscape,cssFlex
...
if version >= 508 || !exists("did_css_syn_inits")
  ...
  HiLink cssIdentifier cssId
  HiLink cssClassName cssClass
  delcommand HiLink
endif
